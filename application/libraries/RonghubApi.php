...
class RonghubApi{
    ...
    public $appKey='k51hidwq1yt4b';                //appKey
    public $appSecret='FatV8x1bzl2Lww';             //secret
     ...
     * @param string $format
     */
    public function __construct($appKey='k51hidwq1yt4b',$appSecret='FatV8x1bzl2Lww',$format = 'json'){
