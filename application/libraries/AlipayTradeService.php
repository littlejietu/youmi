...
require_once 'alipay-sdk/model/result/AlipayF2FPayResult.php';
require_once 'alipay-sdk/model/result/AlipayF2FQueryResult.php';
require_once 'alipay-sdk/model/result/AlipayF2FRefundResult.php';
require_once 'alipay-sdk/model/result/AlipayF2FPrecreateResult.php';
require_once 'alipay-sdk/model/builder/AlipayTradeQueryContentBuilder.php';
require_once 'alipay-sdk/model/builder/AlipayTradeCancelContentBuilder.php';
...
class AlipayTradeService {
	...
	function writeLog($text) {
		...
		//$text = characet ( $text );
		file_put_contents ( APPPATH."/logs/log.txt", date ( "Y-m-d H:i:s" ) . "  " . $text . "\r\n", FILE_APPEND );
	}
