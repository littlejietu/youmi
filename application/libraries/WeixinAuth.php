...
class WeixinAuth
{
	...
	// public $appid = PayConfig::WxAPPID;
	// public $secret = PayConfig::WxAPPSECRET;
	...
	private function checkSignature($wxConfig)
	{
	...
	public function authz($redirect_uri, $wxConfig)
	{
	...
	function init_auth($code, $wxConfig, $url='',$invite_id=0, $client_type='app')
	{
    ...
    {
         $apiurl = $this->apiurl.'/cgi-bin/menu/get?access_token='.$this->get_access_token();
         $result = $this->ci->curl->simple_get($apiurl);
    ...
    public function menu_create()
    {
    	...
    	$content = '{
            "button": [
...

                {
                    "type": "view", 
                    "name": "我的推广码", 
                    "url": "'.$base_url.'/tmpl/user/myshop.html"
                }, 
            ]
        }';
        ...
        //                     "type": "view", 
        //                     "name": "微商前沿", 
        //                     "url": "'.$base_url.'/news/business"
        //                 }, 
        //                 {
        //                     "type": "view", 
        //                     "name": "最新公告", 
        //                     "url": "'.$base_url.'/news/notice"
        //                 }
        //             ]
        //         },
        ...
        $result = $this->ci->curl->simple_post($this->apiurl.'/cgi-bin/menu/create?access_token='.$this->get_access_token(), $content); 
        echo $result;
        $this->menu_get();
    }
} 