...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>油品管理</h3>
      <ul class="tab-base">
      <li><a href="<?php echo SELLER_SITE_URL.'/price?site_id='.$arrParam['site_id'];?>"><span>油品列表</span></a></li>
      <li><a href="JavaScript:void(0);" class="current"><span>添加油品</span></a></li>
     </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form id="add_form" method="post" action="<?php echo SELLER_SITE_URL.'/price/save'?>">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" id="oil_no" name="oil_no" class="txt" value="<?php echo !empty($info)?$info['oil_no']:'';?>" ></td>
          <td class="vatop tips">请输入油品名称</td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label class="validation" for="price">价格:</label></td>
        </tr>
        <tr class="noborder">
