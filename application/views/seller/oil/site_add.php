...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>加油站管理</h3>
      <ul class="tab-base">
      <li><a href="<?php echo SELLER_SITE_URL.'/site';?>"><span>加油站列表</span></a></li>
      <li><a href="JavaScript:void(0);" class="current"><span>添加加油站</span></a></li>
     </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form id="add_form" method="post" action="<?php echo SELLER_SITE_URL.'/site/save'?>">
        ...
        <tr class="noborder">
          <td class="vatop rowform">
            <div class="upload_block">
              <span class="type-file-show"><img class="show_image" src="<?php echo _get_cfg_path('seller_images');?>preview.png">
