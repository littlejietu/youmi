    ...
    <table class="table tb-type2">
      <thead>
        ...
        <tr class="thead">
          ...
          <th class="align-center"><?php echo lang('admin_index_status');?>  </th>
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="align-center">
              <?php if($v['is_super'] == 1){?>
            <?php echo lang('admin_index_sys_admin');?>
            <?php }else{?>
              <?php echo $v['role_name']; ?></td>
            <?php }?>
          <td class="align-center"><?php if($v['status'] == 1||$v['status'] == 2){?>
            <?php echo lang('admin_index_status_enable');?>
            <?php }else{?>
             <?php echo lang('admin_index_status_disable');?>
            <?php }?></td>
