...
<div class="login-layout">
  <div class="top">
   ...
   <form method="post" id="form_login" action="/admin/login/login">
    ...
    <div class="submit">
        ...
        <div class="code">
            <div class="arrow"></div>
            <div class="code-img"><img  name="codeimage" id="codeimage" border="0" src="/seller/Login/captcha?<?php echo rand(10000,99999);?>"/></div>
            <a href="JavaScript:void(0);" id="hide" class="close" title="<?php echo lang('login_index_close_checkcode');?>"><i></i></a>
            <a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='/seller/Login/captcha?<?php echo rand(10000,99999);?>'" class="change" title="看不清,点击更换验证码"><i></i></a>
        </div>
