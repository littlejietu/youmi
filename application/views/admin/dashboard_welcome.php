...
<?php echo _get_html_cssjs('admin_js','jquery.js,jquery.validation.min.js,admincp.js','js');?>
<link href="<?php echo _get_cfg_path('admin').TPL_ADMIN_NAME;?>css/skin_0.css" rel="stylesheet" type="text/css" id="cssfile2" />
...
<?php echo _get_html_cssjs('admin_js','perfect-scrollbar.min.js,jquery.mousewheel.js','js');?>
...
<div class="page">
  ...
  <div class="info-panel">
    <dl class="member">
      ...
      <dd>
        <ul>
          <li class="w100pre normal"><a href="/admin/operation">基本设置</a></li>
        </ul>
      </dd>
    </dl>
    ...
    <dl class="trade">
      ...
      <dd>
        <ul>
          <li class="w100pre none"><a href="/admin/order/index">订单管理</a></li>
        </ul>
      </dd>
    </dl>
    <dl class="operation">
      ...
      <dd>
        <ul>
          <li class="w50pre none"><a href="/admin/company/">公司管理</a></li>
          <li class="w50pre none"><a href="/admin/site/">加油站管理</a></li>
        </ul>
      </dd>
    </dl>
    <div class="clear"></div>
